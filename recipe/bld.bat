...
:: This includes CI/CD variables, development tools, and conda package pins that aren't needed for Bazel

:: Call the environment cleanup script
call "%RECIPE_DIR%\unset_env_vars.bat"
